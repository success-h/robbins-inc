...
export default function Hero({ dict }: SectionProps) {
  return (
    <section className="relative pt-44  h-screen place-items-center place-content-center">
      <div className="px-4">
        <h1 className="max-md:text-center font-bold md:-mt-96 text-[100px] md:text-[200px] text-start">
          {dict.hero.title}
        </h1>
        <p
      ...
      <Image
        className="md:absolute mt-20 md:top-1/2 max-md:mt-10 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2"
        src={'/hero.png'}
        height={300}
        width={300}
        alt="hero"
